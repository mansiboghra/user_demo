...
GIT_REPO_URL="https://github.com/mansiboghra/user_demo.git"
...
PROJECT_MAIN_DIR_NAME="user_demo"

# Clone repository
git clone "$GIT_REPO_URL" "/home/ubuntu/user_demo"

cd "/home/ubuntu/user_demo"
